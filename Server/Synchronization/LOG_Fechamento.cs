...
namespace SyCrafEngine
{
	public class LOG_Fechamento : Synchronization
	{
		...
		public LOG_Fechamento ()
		{
			var_Serial = TB_LOG_FECHAMENTO.serial;
			var_Tablename = TB_LOG_FECHAMENTO.Alias;
		}
		
		public LOG_Fechamento ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_st_mes, string var_st_ano, string var_vr_valor, string var_dt_fechamento, string var_fk_empresa, string var_fk_loja, string var_fk_cartao, string var_fk_parcela, string var_dt_compra, string var_nu_parcela, string var_st_cartao, string var_st_afiliada )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_st_mes ( var_st_mes );
			set_st_ano ( var_st_ano );
			...
			set_st_cartao ( var_st_cartao );
			set_st_afiliada ( var_st_afiliada );
			
			if ( create_LOG_Fechamento() == false )
			{
				return false;
			}
