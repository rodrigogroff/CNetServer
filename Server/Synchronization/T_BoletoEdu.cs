...
namespace SyCrafEngine
{
	public class T_BoletoEdu : Synchronization
	{
		...
		public T_BoletoEdu ()
		{
			var_Serial = TB_T_BOLETOEDU.serial;
			var_Tablename = TB_T_BOLETOEDU.Alias;
		}
		
		public T_BoletoEdu ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_dt_emissao, string var_vr_imediato, string var_vr_educacional, string var_fk_cartao )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_dt_emissao ( var_dt_emissao );
			set_vr_imediato ( var_vr_imediato );
			set_vr_educacional ( var_vr_educacional );
			set_fk_cartao ( var_fk_cartao );
			
			if ( create_T_BoletoEdu() == false )
			{
				return false;
			}
