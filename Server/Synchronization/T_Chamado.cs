...
namespace SyCrafEngine
{
	public class T_Chamado : Synchronization
	{
		...
		public T_Chamado ()
		{
			var_Serial = TB_T_CHAMADO.serial;
			var_Tablename = TB_T_CHAMADO.Alias;
		}
		
		public T_Chamado ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_loja, string var_tg_fechado, string var_fk_operador, string var_nu_prioridade, string var_nu_categoria, string var_dt_abertura, string var_dt_fechamento, string var_st_motivo, string var_tg_tecnico, string var_fk_oper_criador )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_tg_fechado ( var_tg_fechado );
			set_fk_operador ( var_fk_operador );
			set_nu_prioridade ( var_nu_prioridade );
			set_nu_categoria ( var_nu_categoria );
			set_dt_abertura ( var_dt_abertura );
			set_dt_fechamento ( var_dt_fechamento );
			set_st_motivo ( var_st_motivo );
			set_tg_tecnico ( var_tg_tecnico );
			set_fk_oper_criador ( var_fk_oper_criador );
			
			if ( create_T_Chamado() == false )
			{
				return false;
			}
