...
namespace SyCrafEngine
{
	public class T_Edu_AplicacaoVirtual : Synchronization
	{
		...
		public T_Edu_AplicacaoVirtual ()
		{
			var_Serial = TB_T_EDU_APLICACAOVIRTUAL.serial;
			var_Tablename = TB_T_EDU_APLICACAOVIRTUAL.Alias;
		}
		
		public T_Edu_AplicacaoVirtual ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_cartao, string var_fk_empresaVirtual, string var_vr_aplicado, string var_dt_aplic, string var_tg_neg, string var_vr_fundo_hora, string var_vr_preco_fundo )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_vr_aplicado ( var_vr_aplicado );
			set_dt_aplic ( var_dt_aplic );
			set_tg_neg ( var_tg_neg );
			set_vr_fundo_hora ( var_vr_fundo_hora );
			set_vr_preco_fundo ( var_vr_preco_fundo );
			
			if ( create_T_Edu_AplicacaoVirtual() == false )
			{
				return false;
			}
