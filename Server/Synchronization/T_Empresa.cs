...
namespace SyCrafEngine
{
	public class T_Empresa : Synchronization
	{
		...
		public T_Empresa ()
		{
			var_Serial = TB_T_EMPRESA.serial;
			var_Tablename = TB_T_EMPRESA.Alias;
		}
		
		public T_Empresa ( Transaction trx )
		{
		...
		public override void fetchRetrieve ( ref DB_Row row )
		{
            ...
            st_homepage = row.GetField(TB_T_EMPRESA.st_homepage);
		...
		public bool synchronize_T_Empresa ( )
		{
            ...
            if (m_hshChangedFields["st_homepage"] != null)
                m_gen_dbStatement.AddUpdate(TB_T_EMPRESA.st_homepage, st_homepage, TB_T_EMPRESA.type_st_homepage);
        ...
        public string get_st_homepage() { return st_homepage; } 
        ...
        public void set_st_homepage(string val) { st_homepage = val; m_hshChangedFields["st_homepage"] = "."; } 
		...
		public void fieldSelection()
		{
            ...
            m_gen_dbStatement.AddSelect(TB_T_EMPRESA.st_homepage);
		...
		public bool create_T_Empresa ( )
		{
            ...
            m_gen_dbStatement.AddValue (TB_T_EMPRESA.st_homepage, st_homepage, TB_T_EMPRESA.type_st_homepage);
		...
		public bool setup ( bool IsTruncate, ref string id, string var_st_empresa, string var_nu_CNPJ, string var_st_fantasia, string var_st_social, string var_st_endereco, string var_st_cidade, string var_st_estado, string var_nu_CEP, string var_nu_telefone, string var_nu_cartoes, string var_nu_parcelas, string var_tg_blocked, string var_fk_admin, string var_nu_contaDeb, string var_vr_mensalidade, string var_nu_pctValor, string var_vr_transacao, string var_vr_minimo, string var_nu_franquia, string var_nu_periodoFat, string var_nu_diaVenc, string var_tg_tipoCobranca, string var_nu_bancoFat, string var_vr_cartaoAtivo, string var_tg_isentoFat, string var_st_obs, string var_st_homepage, string var_tg_bloq )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_st_fantasia ( var_st_fantasia );
			...
			set_vr_cartaoAtivo ( var_vr_cartaoAtivo );
			set_tg_isentoFat ( var_tg_isentoFat );
			set_st_obs ( var_st_obs );
            set_st_homepage(var_st_homepage);
			set_tg_bloq ( var_tg_bloq );
			
			if ( create_T_Empresa() == false )
			{
				return false;
			}
