...
namespace SyCrafEngine
{
	public class LOG_VendaProdutoGift : Synchronization
	{
		...
		public LOG_VendaProdutoGift ()
		{
			var_Serial = TB_LOG_VENDAPRODUTOGIFT.serial;
			var_Tablename = TB_LOG_VENDAPRODUTOGIFT.Alias;
		}
		
		public LOG_VendaProdutoGift ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_vendaCartao, string var_st_produto, string var_vr_valor )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_fk_vendaCartao ( var_fk_vendaCartao );
			set_st_produto ( var_st_produto );
			set_vr_valor ( var_vr_valor );
			
			if ( create_LOG_VendaProdutoGift() == false )
			{
				return false;
			}
