...
namespace SyCrafEngine
{
	public class LINK_LojaEmpresa : Synchronization
	{
		...
		public LINK_LojaEmpresa ()
		{
			var_Serial = TB_LINK_LOJAEMPRESA.serial;
			var_Tablename = TB_LINK_LOJAEMPRESA.Alias;
		}
		
		public LINK_LojaEmpresa ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_loja, string var_fk_empresa, string var_tx_admin, string var_nu_dias_repasse, string var_st_ag, string var_st_conta, string var_st_banco )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_tx_admin ( var_tx_admin );
			set_nu_dias_repasse ( var_nu_dias_repasse );
			set_st_ag ( var_st_ag );
			set_st_conta ( var_st_conta );
			set_st_banco ( var_st_banco );
			
			if ( create_LINK_LojaEmpresa() == false )
			{
				return false;
			}
