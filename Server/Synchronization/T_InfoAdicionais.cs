...
namespace SyCrafEngine
{
	public class T_InfoAdicionais : Synchronization
	{
		...
		public T_InfoAdicionais ()
		{
			var_Serial = TB_T_INFOADICIONAIS.serial;
			var_Tablename = TB_T_INFOADICIONAIS.Alias;
		}
		
		public T_InfoAdicionais ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_st_codigo, string var_st_empresaAfiliada, string var_st_presenteado, string var_st_recado, string var_dt_edu_nasc, string var_st_edu_sexo, string var_st_edu_grau, string var_st_edu_serie_semestre, string var_st_edu_turma, string var_st_edu_curso, string var_dt_edu_atualizacao, string var_st_empresa, string var_st_matricula )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_st_empresaAfiliada ( var_st_empresaAfiliada );
			set_st_presenteado ( var_st_presenteado );
			set_st_recado ( var_st_recado );
			set_dt_edu_nasc ( var_dt_edu_nasc );
			set_st_edu_sexo ( var_st_edu_sexo );
			set_st_edu_grau ( var_st_edu_grau );
			set_st_edu_serie_semestre ( var_st_edu_serie_semestre );
			set_st_edu_turma ( var_st_edu_turma );
			set_st_edu_curso ( var_st_edu_curso );
			set_dt_edu_atualizacao ( var_dt_edu_atualizacao );
			set_st_empresa ( var_st_empresa );
			set_st_matricula ( var_st_matricula );
			
			if ( create_T_InfoAdicionais() == false )
			{
				return false;
			}
