...
namespace SyCrafEngine
{
	public class T_ExtraGift : Synchronization
	{
		...
		public T_ExtraGift ()
		{
			var_Serial = TB_T_EXTRAGIFT.serial;
			var_Tablename = TB_T_EXTRAGIFT.Alias;
		}
		
		public T_ExtraGift ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_st_nome, string var_vr_valor, string var_fk_empresa )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
