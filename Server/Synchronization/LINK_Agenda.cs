...
namespace SyCrafEngine
{
	public class LINK_Agenda : Synchronization
	{
		...
		public LINK_Agenda ()
		{
			var_Serial = TB_LINK_AGENDA.serial;
			var_Tablename = TB_LINK_AGENDA.Alias;
		}
		
		public LINK_Agenda ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_schedule, string var_fk_empresa, string var_en_atividade, string var_st_emp_afiliada )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_fk_schedule ( var_fk_schedule );
			set_fk_empresa ( var_fk_empresa );
			set_en_atividade ( var_en_atividade );
			set_st_emp_afiliada ( var_st_emp_afiliada );
			
			if ( create_LINK_Agenda() == false )
			{
				return false;
			}
