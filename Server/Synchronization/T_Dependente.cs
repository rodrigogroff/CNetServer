...
namespace SyCrafEngine
{
	public class T_Dependente : Synchronization
	{
		...
		public T_Dependente ()
		{
			var_Serial = TB_T_DEPENDENTE.serial;
			var_Tablename = TB_T_DEPENDENTE.Alias;
		}
		
		public T_Dependente ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_nu_titularidade, string var_st_nome, string var_fk_proprietario )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_nu_titularidade ( var_nu_titularidade );
			set_st_nome ( var_st_nome );
			set_fk_proprietario ( var_fk_proprietario );
			
			if ( create_T_Dependente() == false )
			{
				return false;
			}
