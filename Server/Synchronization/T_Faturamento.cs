...
namespace SyCrafEngine
{
	public class T_Faturamento : Synchronization
	{
		...
		public T_Faturamento ()
		{
			var_Serial = TB_T_FATURAMENTO.serial;
			var_Tablename = TB_T_FATURAMENTO.Alias;
		}
		
		public T_Faturamento ( Transaction trx )
		{
		...
		public bool setup ( bool IsTruncate, ref string id, string var_fk_empresa, string var_fk_loja, string var_vr_cobranca, string var_dt_vencimento, string var_dt_baixa, string var_tg_situacao, string var_tg_retBanco )
		{
			if ( IsTruncate ) 
			{
				i_unique = "";
			...
			set_dt_vencimento ( var_dt_vencimento );
			set_dt_baixa ( var_dt_baixa );
			set_tg_situacao ( var_tg_situacao );
			set_tg_retBanco ( var_tg_retBanco );
			
			if ( create_T_Faturamento() == false )
			{
				return false;
			}
