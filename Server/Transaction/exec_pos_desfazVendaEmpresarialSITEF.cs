...
{
	public class exec_pos_desfazVendaEmpresarial : Transaction
	{
		...
		public exec_pos_desfazVendaEmpresarial ( Transaction trans ) : base (trans)
		{
			var_Alias = "exec_pos_desfazVendaEmpresarial";
			constructor();
		}
		
		public exec_pos_desfazVendaEmpresarial()
		{
			var_Alias = "exec_pos_desfazVendaEmpresarial";
		...
		public override bool setup ( ) 
		{
			...
			Registry ( "setup exec_pos_desfazVendaEmpresarial " ); 
			...
			Registry ( "setup done exec_pos_desfazVendaEmpresarial " ); 
			#endregion
		...
		{
			Registry ( "execute exec_pos_desfazVendaEmpresarial " ); 
			...
			Registry ( "execute done exec_pos_desfazVendaEmpresarial " ); 
		...
		{
			Registry ( "finish exec_pos_desfazVendaEmpresarial " ); 
			...
			Registry ( "finish done exec_pos_desfazVendaEmpresarial " ); 
