...
{
	public class exec_pos_vendaEmpresarialSITEF : Transaction
	{
		...
		public exec_pos_vendaEmpresarialSITEF( Transaction trans ) : base (trans)
		{
			var_Alias = "exec_pos_vendaEmpresarialSITEF";
			constructor();
		}
		
		public exec_pos_vendaEmpresarialSITEF()
		{
			var_Alias = "exec_pos_vendaEmpresarialSITEF";
		...
		public override bool setup ( ) 
		{
			...
			Registry ("setup exec_pos_vendaEmpresarialSITEF "); 
