...
{
	#if DEBUG 
	public class tst_exec_desbloq_loja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_desbloq_loja transaction = new exec_desbloq_loja();
		...
		public tst_exec_desbloq_loja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_desbloq_loja" )
			{
			...
			{
				result = " exec_desbloq_loja                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_exec_desbloq_loja (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_desbloq_loja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_desbloq_loja ( st_cnpj, ref  header ); 
