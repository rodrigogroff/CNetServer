...
{
	#if DEBUG 
	public class tst_exec_venda_pend_lojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_venda_pend_lojista transaction = new exec_venda_pend_lojista();
		...
		public tst_exec_venda_pend_lojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_venda_pend_lojista" )
			{
			...
			{
				result = " exec_venda_pend_lojista            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_venda_pend_lojista             " + 
		...
		public void call_exec_venda_pend_lojista ( string st_cartao, string vr_valor, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_venda_pend_lojista (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_venda_pend_lojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_venda_pend_lojista ( st_cartao, vr_valor, ref  header ); 
