...
{
	#if DEBUG 
	public class tst_del_quiosque : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public del_quiosque transaction = new del_quiosque();
		...
		public tst_del_quiosque ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " del_quiosque                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_del_quiosque ( string st_empresa, string st_desc, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "del_quiosque Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_del_quiosque ( st_empresa, st_desc, ref  header ); 
