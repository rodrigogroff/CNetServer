...
{
	#if DEBUG 
	public class tst_schedule_proc_batch : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_proc_batch transaction = new schedule_proc_batch();
		...
		public tst_schedule_proc_batch ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_proc_batch" )
			{
			...
			{
				result = " schedule_proc_batch                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_proc_batch (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_proc_batch (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_proc_batch Item1", ref m_Log );
