...
{
	#if DEBUG 
	public class tst_schedule_faturamento : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_faturamento transaction = new schedule_faturamento();
		...
		public tst_schedule_faturamento ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_faturamento" )
			{
			...
			{
				result = " schedule_faturamento               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_faturamento (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_faturamento (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_faturamento Item1", ref m_Log );
