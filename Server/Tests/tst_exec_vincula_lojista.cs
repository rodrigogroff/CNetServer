...
{
	#if DEBUG 
	public class tst_exec_vincula_lojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_vincula_lojista transaction = new exec_vincula_lojista();
		...
		public tst_exec_vincula_lojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_vincula_lojista" )
			{
			...
			{
				result = " exec_vincula_lojista               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_vincula_lojista ( string st_cod_loja, string id_usuario, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_vincula_lojista (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_vincula_lojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_vincula_lojista ( st_cod_loja, id_usuario, ref  header ); 
