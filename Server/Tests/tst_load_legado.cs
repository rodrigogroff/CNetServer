...
{
	#if DEBUG 
	public class tst_load_legado : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public load_legado transaction = new load_legado();
		...
		public tst_load_legado ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " load_legado                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_load_legado (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_load_legado (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "load_legado Item1", ref m_Log );
