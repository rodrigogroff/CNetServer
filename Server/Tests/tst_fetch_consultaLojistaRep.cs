...
{
	#if DEBUG 
	public class tst_fetch_consultaLojistaRep : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_consultaLojistaRep transaction = new fetch_consultaLojistaRep();
		...
		public tst_fetch_consultaLojistaRep ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_consultaLojistaRep" )
			{
			...
			{
				result = " fetch_consultaLojistaRep           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_consultaLojistaRep            " + 
		...
		public void call_fetch_consultaLojistaRep ( string cnpj, string pass, string mes, string ano, string empresa ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_consultaLojistaRep ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_consultaLojistaRep Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_consultaLojistaRep ( cnpj, pass, mes, ano, empresa ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_consultaLojistaRep ( ref st_content ); 
