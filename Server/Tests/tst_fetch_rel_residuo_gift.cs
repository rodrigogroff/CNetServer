...
{
	#if DEBUG 
	public class tst_fetch_rel_residuo_gift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_rel_residuo_gift transaction = new fetch_rel_residuo_gift();
		...
		public tst_fetch_rel_residuo_gift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_rel_residuo_gift" )
			{
			...
			{
				result = " fetch_rel_residuo_gift             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
