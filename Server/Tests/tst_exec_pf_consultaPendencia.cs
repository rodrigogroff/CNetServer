...
{
	#if DEBUG 
	public class tst_exec_pf_consultaPendencia : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_consultaPendencia transaction = new exec_pf_consultaPendencia();
		...
		public tst_exec_pf_consultaPendencia ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_consultaPendencia" )
			{
			...
			{
				result = " exec_pf_consultaPendencia          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pf_consultaPendencia           " + 
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_consultaPendencia Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_consultaPendencia ( st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_consultaPendencia ( ref st_nsu, ref st_valor, ref st_nomeLoja, ref st_codResp, ref st_msg ); 
