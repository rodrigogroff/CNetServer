...
{
	#if DEBUG 
	public class tst_exec_cancelaEmpresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_cancelaEmpresa transaction = new exec_cancelaEmpresa();
		...
		public tst_exec_cancelaEmpresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_cancelaEmpresa" )
			{
			...
			{
				result = " exec_cancelaEmpresa                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_cancelaEmpresa ( string st_pass_user, string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_cancelaEmpresa (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_cancelaEmpresa Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_cancelaEmpresa ( st_pass_user, st_empresa, ref  header ); 
