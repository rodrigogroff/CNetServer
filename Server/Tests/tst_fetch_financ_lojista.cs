...
{
	#if DEBUG 
	public class tst_fetch_financ_lojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_financ_lojista transaction = new fetch_financ_lojista();
		...
		public tst_fetch_financ_lojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_financ_lojista" )
			{
			...
			{
				result = " fetch_financ_lojista               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_financ_lojista ( string dt, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_financ_lojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_financ_lojista ( dt, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_financ_lojista ( ref oper, ref vendas, ref canc ); 
