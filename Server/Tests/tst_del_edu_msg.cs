...
{
	#if DEBUG 
	public class tst_del_edu_msg : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public del_edu_msg transaction = new del_edu_msg();
		...
		public tst_del_edu_msg ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " del_edu_msg                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_del_edu_msg ( string id_msg, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "del_edu_msg Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_del_edu_msg ( id_msg, ref  header ); 
