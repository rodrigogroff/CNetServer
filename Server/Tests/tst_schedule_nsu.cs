...
{
	#if DEBUG 
	public class tst_schedule_nsu : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_nsu transaction = new schedule_nsu();
		...
		public tst_schedule_nsu ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " schedule_nsu                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_nsu (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_nsu (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_nsu Item1", ref m_Log );
