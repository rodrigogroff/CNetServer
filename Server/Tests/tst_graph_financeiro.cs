...
{
	#if DEBUG 
	public class tst_graph_financeiro : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public graph_financeiro transaction = new graph_financeiro();
		...
		public tst_graph_financeiro ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "graph_financeiro" )
			{
			...
			{
				result = " graph_financeiro                   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_graph_financeiro ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "graph_financeiro Item1", ref m_Log );
			...
			ArrayList lstCurves = new ArrayList();
...
/// USER [ setup_test_1 ] END
			...
			call_graph_financeiro ( tg_tipo, ref  header, ref lstCurves ); 
...
/// USER [ execute_1 ] END
			...
			recv_graph_financeiro ( ref st_content ); 
