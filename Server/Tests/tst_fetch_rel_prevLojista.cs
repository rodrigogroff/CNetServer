...
{
	#if DEBUG 
	public class tst_fetch_rel_prevLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_rel_prevLojista transaction = new fetch_rel_prevLojista();
		...
		public tst_fetch_rel_prevLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_rel_prevLojista" )
			{
			...
			{
				result = " fetch_rel_prevLojista              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_rel_prevLojista ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_rel_prevLojista ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_rel_prevLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_rel_prevLojista ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_rel_prevLojista ( ref st_csv ); 
