...
{
	#if DEBUG 
	public class tst_exec_cancelaDespesa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_cancelaDespesa transaction = new exec_cancelaDespesa();
		...
		public tst_exec_cancelaDespesa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_cancelaDespesa" )
			{
			...
			{
				result = " exec_cancelaDespesa                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_cancelaDespesa ( string fk_faturamentoDetalhe, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_cancelaDespesa (  )
		{
		}
