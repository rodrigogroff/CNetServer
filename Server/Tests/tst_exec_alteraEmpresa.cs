...
{
	#if DEBUG 
	public class tst_exec_alteraEmpresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraEmpresa transaction = new exec_alteraEmpresa();
		...
		public tst_exec_alteraEmpresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraEmpresa" )
			{
			...
			{
				result = " exec_alteraEmpresa                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_exec_alteraEmpresa (  )
		{
		}
