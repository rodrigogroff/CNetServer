...
{
	#if DEBUG 
	public class tst_exec_pf_graficoGerencial : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_graficoGerencial transaction = new exec_pf_graficoGerencial();
		...
		public tst_exec_pf_graficoGerencial ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_graficoGerencial" )
			{
			...
			{
				result = " exec_pf_graficoGerencial           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pf_graficoGerencial            " + 
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_graficoGerencial Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_graficoGerencial ( tg_tipo ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_graficoGerencial ( ref lst ); 
