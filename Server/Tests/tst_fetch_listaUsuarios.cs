...
{
	#if DEBUG 
	public class tst_fetch_listaUsuarios : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_listaUsuarios transaction = new fetch_listaUsuarios();
		...
		public tst_fetch_listaUsuarios ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_listaUsuarios" )
			{
			...
			{
				result = " fetch_listaUsuarios                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_listaUsuarios ( ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_listaUsuarios ( ref string st_csv_id )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_listaUsuarios Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_listaUsuarios ( ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_listaUsuarios ( ref st_csv_id ); 
