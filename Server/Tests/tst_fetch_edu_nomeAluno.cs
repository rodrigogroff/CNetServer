...
{
	#if DEBUG 
	public class tst_fetch_edu_nomeAluno : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_edu_nomeAluno transaction = new fetch_edu_nomeAluno();
		...
		public tst_fetch_edu_nomeAluno ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_edu_nomeAluno" )
			{
			...
			{
				result = " fetch_edu_nomeAluno                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_edu_nomeAluno ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_edu_nomeAluno Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_edu_nomeAluno ( st_nome, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_edu_nomeAluno ( ref st_csv ); 
