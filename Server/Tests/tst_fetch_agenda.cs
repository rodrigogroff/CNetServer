...
{
	#if DEBUG 
	public class tst_fetch_agenda : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_agenda transaction = new fetch_agenda();
		...
		public tst_fetch_agenda ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " fetch_agenda                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_agenda ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_agenda Item1", ref m_Log );
