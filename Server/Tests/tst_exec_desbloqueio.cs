...
{
	#if DEBUG 
	public class tst_exec_desbloqueio : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_desbloqueio transaction = new exec_desbloqueio();
		...
		public tst_exec_desbloqueio ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_desbloqueio" )
			{
			...
			{
				result = " exec_desbloqueio                   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_desbloqueio ( string st_cartao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_desbloqueio (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_desbloqueio Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_desbloqueio ( st_cartao, ref  header ); 
