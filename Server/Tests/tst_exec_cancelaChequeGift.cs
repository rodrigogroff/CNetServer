...
{
	#if DEBUG 
	public class tst_exec_cancelaChequeGift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_cancelaChequeGift transaction = new exec_cancelaChequeGift();
		...
		public tst_exec_cancelaChequeGift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_cancelaChequeGift" )
			{
			...
			{
				result = " exec_cancelaChequeGift             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_cancelaChequeGift ( string st_ident, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_cancelaChequeGift (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_cancelaChequeGift Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_cancelaChequeGift ( st_ident, ref  header ); 
