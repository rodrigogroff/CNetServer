...
{
	#if DEBUG 
	public class tst_fetch_consultaLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_consultaLojista transaction = new fetch_consultaLojista();
		...
		public tst_fetch_consultaLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_consultaLojista" )
			{
			...
			{
				result = " fetch_consultaLojista              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_consultaLojista ( string cnpj, string dt_ini, string dt_fim, string pass ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_consultaLojista ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_consultaLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_consultaLojista ( cnpj, dt_ini, dt_fim, pass ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_consultaLojista ( ref st_content ); 
