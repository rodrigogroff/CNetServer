...
{
	#if DEBUG 
	public class tst_fetch_consultaLojasGift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_consultaLojasGift transaction = new fetch_consultaLojasGift();
		...
		public tst_fetch_consultaLojasGift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_consultaLojasGift" )
			{
			...
			{
				result = " fetch_consultaLojasGift            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_consultaLojasGift             " + 
		...
		public void call_fetch_consultaLojasGift ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_consultaLojasGift ( ref string st_csv_id )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_consultaLojasGift Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_consultaLojasGift ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_consultaLojasGift ( ref st_csv_id ); 
