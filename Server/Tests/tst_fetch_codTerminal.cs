...
{
	#if DEBUG 
	public class tst_fetch_codTerminal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_codTerminal transaction = new fetch_codTerminal();
		...
		public tst_fetch_codTerminal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_codTerminal" )
			{
			...
			{
				result = " fetch_codTerminal                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_codTerminal ( ref string st_terminal )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_codTerminal Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_codTerminal ( ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_codTerminal ( ref st_terminal ); 
