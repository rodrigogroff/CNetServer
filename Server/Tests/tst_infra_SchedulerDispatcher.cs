...
{
	#if DEBUG 
	public class tst_infra_SchedulerDispatcher : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public infra_SchedulerDispatcher transaction = new infra_SchedulerDispatcher();
		...
		public tst_infra_SchedulerDispatcher ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "infra_SchedulerDispatcher" )
			{
			...
			{
				result = " infra_SchedulerDispatcher          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " infra_SchedulerDispatcher           " + 
		...
		public void call_infra_SchedulerDispatcher (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_infra_SchedulerDispatcher (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "infra_SchedulerDispatcher Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_infra_SchedulerDispatcher (  ); 
