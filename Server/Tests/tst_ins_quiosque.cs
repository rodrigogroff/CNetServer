...
{
	#if DEBUG 
	public class tst_ins_quiosque : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_quiosque transaction = new ins_quiosque();
		...
		public tst_ins_quiosque ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_quiosque                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_quiosque ( string st_empresa, string st_desc, ref CNetHeader header ) 
		{
			m_Comm.Clear();
