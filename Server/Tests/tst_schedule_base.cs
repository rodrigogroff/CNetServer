...
{
	#if DEBUG 
	public class tst_schedule_base : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_base transaction = new schedule_base();
		...
		public tst_schedule_base ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_base" )
			{
			...
			{
				result = " schedule_base                      " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_base (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_base (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_base Item1", ref m_Log );
