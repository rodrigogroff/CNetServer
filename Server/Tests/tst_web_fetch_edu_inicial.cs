...
{
	#if DEBUG 
	public class tst_web_fetch_edu_inicial : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public web_fetch_edu_inicial transaction = new web_fetch_edu_inicial();
		...
		public tst_web_fetch_edu_inicial ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "web_fetch_edu_inicial" )
			{
			...
			{
				result = " web_fetch_edu_inicial              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_web_fetch_edu_inicial ( string st_cpf, string st_cartao, string st_senha, string st_ip ) 
		{
			m_Comm.Clear();
		...
		public void recv_web_fetch_edu_inicial ( ref string tg_resp )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "web_fetch_edu_inicial Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_web_fetch_edu_inicial ( st_cpf, st_cartao, st_senha, st_ip ); 
...
/// USER [ execute_1 ] END
			...
			recv_web_fetch_edu_inicial ( ref tg_resp ); 
