...
{
	#if DEBUG 
	public class tst_fetch_softwareVersion : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_softwareVersion transaction = new fetch_softwareVersion();
		...
		public tst_fetch_softwareVersion ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_softwareVersion" )
			{
			...
			{
				result = " fetch_softwareVersion              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_softwareVersion ( ref string st_versionOutdated )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_softwareVersion Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_softwareVersion ( st_version ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_softwareVersion ( ref st_versionOutdated ); 
