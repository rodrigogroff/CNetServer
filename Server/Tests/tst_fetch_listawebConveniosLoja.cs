...
{
	#if DEBUG 
	public class tst_fetch_listawebConveniosLoja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_listawebConveniosLoja transaction = new fetch_listawebConveniosLoja();
		...
		public tst_fetch_listawebConveniosLoja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_listawebConveniosLoja" )
			{
			...
			{
				result = " fetch_listawebConveniosLoja        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_listawebConveniosLoja         " + 
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_listawebConveniosLoja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_listawebConveniosLoja ( st_loja, st_senha ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_listawebConveniosLoja ( ref lst ); 
