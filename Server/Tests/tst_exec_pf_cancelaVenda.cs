...
{
	#if DEBUG 
	public class tst_exec_pf_cancelaVenda : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_cancelaVenda transaction = new exec_pf_cancelaVenda();
		...
		public tst_exec_pf_cancelaVenda ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_cancelaVenda" )
			{
			...
			{
				result = " exec_pf_cancelaVenda               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_pf_cancelaVenda ( string st_nsu_cancelado, string st_tel_lojista, string st_telefone ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_cancelaVenda Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_cancelaVenda ( st_nsu_cancelado, st_tel_lojista, st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_cancelaVenda ( ref st_codResp, ref st_msg ); 
