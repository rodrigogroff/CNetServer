...
{
	#if DEBUG 
	public class tst_fetch_proprietario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_proprietario transaction = new fetch_proprietario();
		...
		public tst_fetch_proprietario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_proprietario" )
			{
			...
			{
				result = " fetch_proprietario                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
