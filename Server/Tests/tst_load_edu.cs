...
{
	#if DEBUG 
	public class tst_load_edu : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public load_edu transaction = new load_edu();
		...
		public tst_load_edu ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " load_edu                           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_load_edu (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_load_edu (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "load_edu Item1", ref m_Log );
