...
{
	#if DEBUG 
	public class tst_exec_compensaChequeGift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_compensaChequeGift transaction = new exec_compensaChequeGift();
		...
		public tst_exec_compensaChequeGift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_compensaChequeGift" )
			{
			...
			{
				result = " exec_compensaChequeGift            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_compensaChequeGift             " + 
		...
		public void call_exec_compensaChequeGift ( string st_ident, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_compensaChequeGift (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_compensaChequeGift Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_compensaChequeGift ( st_ident, ref  header ); 
