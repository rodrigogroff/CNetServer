...
{
	#if DEBUG 
	public class tst_exec_alteraProprietario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraProprietario transaction = new exec_alteraProprietario();
		...
		public tst_exec_alteraProprietario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraProprietario" )
			{
			...
			{
				result = " exec_alteraProprietario            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_alteraProprietario             " + 
		...
		public void call_exec_alteraProprietario ( string st_cpf_cnpj, ref DadosProprietario dp, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_alteraProprietario (  )
		{
		}
