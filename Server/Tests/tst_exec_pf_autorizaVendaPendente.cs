...
{
	#if DEBUG 
	public class tst_exec_pf_autorizaVendaPendente : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_autorizaVendaPendente transaction = new exec_pf_autorizaVendaPendente();
		...
		public tst_exec_pf_autorizaVendaPendente ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_autorizaVendaPendente" )
			{
			...
			{
				result = " exec_pf_autorizaVendaPendente      " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pf_autorizaVendaPendente       " + 
		...
		public void call_exec_pf_autorizaVendaPendente ( string st_nsu, string st_senha, string st_telefone ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_autorizaVendaPendente Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_autorizaVendaPendente ( st_nsu, st_senha, st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			string st_nsu_autorizado = "";
			string st_codResp = "";
			string st_msg = "";

			recv_exec_pf_autorizaVendaPendente ( ref st_nsu_autorizado, ref st_codResp, ref st_msg ); 
