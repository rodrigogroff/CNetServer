...
{
	#if DEBUG 
	public class tst_exec_alteraUsuario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraUsuario transaction = new exec_alteraUsuario();
		...
		public tst_exec_alteraUsuario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraUsuario" )
			{
			...
			{
				result = " exec_alteraUsuario                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_alteraUsuario ( string tg_action, string id_usuario, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_alteraUsuario (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_alteraUsuario Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_alteraUsuario ( tg_action, id_usuario, ref  header ); 
