...
{
	#if DEBUG 
	public class tst_type_load : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public type_load transaction = new type_load();
		...
		public tst_type_load ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " type_load                          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_type_load (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_type_load (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "type_load Item1", ref m_Log );
