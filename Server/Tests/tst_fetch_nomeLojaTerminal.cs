...
{
	#if DEBUG 
	public class tst_fetch_nomeLojaTerminal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_nomeLojaTerminal transaction = new fetch_nomeLojaTerminal();
		...
		public tst_fetch_nomeLojaTerminal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_nomeLojaTerminal" )
			{
			...
			{
				result = " fetch_nomeLojaTerminal             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_nomeLojaTerminal ( ref string st_nome_loja )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_nomeLojaTerminal Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_nomeLojaTerminal ( st_terminal, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_nomeLojaTerminal ( ref st_nome_loja ); 
