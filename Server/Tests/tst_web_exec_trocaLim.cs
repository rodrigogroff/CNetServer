...
{
	#if DEBUG 
	public class tst_web_exec_trocaLim : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public web_exec_trocaLim transaction = new web_exec_trocaLim();
		...
		public tst_web_exec_trocaLim ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "web_exec_trocaLim" )
			{
			...
			{
				result = " web_exec_trocaLim                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_web_exec_trocaLim ( string st_cartao, string st_senha, string vr_dispDiario, string tg_semanaToda ) 
		{
			m_Comm.Clear();
		...
		public void recv_web_exec_trocaLim (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "web_exec_trocaLim Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_cartao = "";
			string st_senha = "";
			string vr_dispDiario = "";
			string tg_semanaToda = "";
...
/// USER [ setup_test_1 ] END
			...
			call_web_exec_trocaLim ( st_cartao, st_senha, vr_dispDiario, tg_semanaToda ); 
