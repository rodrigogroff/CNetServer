...
{
	#if DEBUG 
	public class tst_web_exec_alterSenhaEdu : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public web_exec_alterSenhaEdu transaction = new web_exec_alterSenhaEdu();
		...
		public tst_web_exec_alterSenhaEdu ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "web_exec_alterSenhaEdu" )
			{
			...
			{
				result = " web_exec_alterSenhaEdu             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_web_exec_alterSenhaEdu ( string st_cpf, string st_senha, string st_novaSenha, string tg_resp ) 
		{
			m_Comm.Clear();
		...
		public void recv_web_exec_alterSenhaEdu (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "web_exec_alterSenhaEdu Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_web_exec_alterSenhaEdu ( st_cpf, st_senha, st_novaSenha, tg_resp ); 
