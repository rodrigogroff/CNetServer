...
{
	#if DEBUG 
	public class tst_ins_payFoneLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_payFoneLojista transaction = new ins_payFoneLojista();
		...
		public tst_ins_payFoneLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "ins_payFoneLojista" )
			{
			...
			{
				result = " ins_payFoneLojista                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_payFoneLojista ( string st_pf_empresa, string st_pf_term, string st_pf_telefone, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_ins_payFoneLojista (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_payFoneLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_payFoneLojista ( st_pf_empresa, st_pf_term, st_pf_telefone, ref  header ); 
