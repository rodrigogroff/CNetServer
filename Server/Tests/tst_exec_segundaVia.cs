...
{
	#if DEBUG 
	public class tst_exec_segundaVia : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_segundaVia transaction = new exec_segundaVia();
		...
		public tst_exec_segundaVia ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_segundaVia" )
			{
			...
			{
				result = " exec_segundaVia                    " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_segundaVia ( string st_empresa, string st_mat, string st_tit, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_segundaVia (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_segundaVia Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_segundaVia ( st_empresa, st_mat, st_tit, ref  header ); 
