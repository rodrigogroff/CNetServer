...
{
	#if DEBUG 
	public class tst_fetch_validaEmpresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_validaEmpresa transaction = new fetch_validaEmpresa();
		...
		public tst_fetch_validaEmpresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_validaEmpresa" )
			{
			...
			{
				result = " fetch_validaEmpresa                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_validaEmpresa ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_validaEmpresa ( ref string st_nome )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_validaEmpresa Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_validaEmpresa ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_validaEmpresa ( ref st_nome ); 
