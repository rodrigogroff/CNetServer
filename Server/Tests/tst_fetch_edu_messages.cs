...
{
	#if DEBUG 
	public class tst_fetch_edu_messages : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_edu_messages transaction = new fetch_edu_messages();
		...
		public tst_fetch_edu_messages ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_edu_messages" )
			{
			...
			{
				result = " fetch_edu_messages                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_edu_messages ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_edu_messages Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_edu_messages ( ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_edu_messages ( ref st_content ); 
