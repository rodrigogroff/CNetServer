...
{
	#if DEBUG 
	public class tst_exec_trocaSenha : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_trocaSenha transaction = new exec_trocaSenha();
		...
		public tst_exec_trocaSenha ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_trocaSenha" )
			{
			...
			{
				result = " exec_trocaSenha                    " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_trocaSenha ( string senha, string nova_senha, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_trocaSenha (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_trocaSenha Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_trocaSenha ( senha, nova_senha, ref  header ); 
