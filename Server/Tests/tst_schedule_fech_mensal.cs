...
{
	#if DEBUG 
	public class tst_schedule_fech_mensal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_fech_mensal transaction = new schedule_fech_mensal();
		...
		public tst_schedule_fech_mensal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_fech_mensal" )
			{
			...
			{
				result = " schedule_fech_mensal               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_fech_mensal (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_fech_mensal (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_fech_mensal Item1", ref m_Log );
