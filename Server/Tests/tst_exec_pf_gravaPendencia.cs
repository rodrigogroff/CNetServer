...
{
	#if DEBUG 
	public class tst_exec_pf_gravaPendencia : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_gravaPendencia transaction = new exec_pf_gravaPendencia();
		...
		public tst_exec_pf_gravaPendencia ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_gravaPendencia" )
			{
			...
			{
				result = " exec_pf_gravaPendencia             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_gravaPendencia Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_telefoneLoja = "";
			string vr_valor = "";
			string st_telefone = "";
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_gravaPendencia ( st_telefoneLoja, vr_valor, st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_gravaPendencia ( ref st_nsu, ref st_codResp, ref st_msg ); 
