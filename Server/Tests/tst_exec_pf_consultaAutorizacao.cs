...
{
	#if DEBUG 
	public class tst_exec_pf_consultaAutorizacao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_consultaAutorizacao transaction = new exec_pf_consultaAutorizacao();
		...
		public tst_exec_pf_consultaAutorizacao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_consultaAutorizacao" )
			{
			...
			{
				result = " exec_pf_consultaAutorizacao        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pf_consultaAutorizacao         " + 
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_consultaAutorizacao Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_consultaAutorizacao ( st_tel_lojista, st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_consultaAutorizacao ( ref st_codResp, ref st_msg, ref lst ); 
