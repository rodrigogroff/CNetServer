...
{
	#if DEBUG 
	public class tst_schedule_batch : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_batch transaction = new schedule_batch();
		...
		public tst_schedule_batch ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_batch" )
			{
			...
			{
				result = " schedule_batch                     " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_batch (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_batch (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_batch Item1", ref m_Log );
