...
{
	#if DEBUG 
	public class tst_fetch_empresasAfiliadas : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_empresasAfiliadas transaction = new fetch_empresasAfiliadas();
		...
		public tst_fetch_empresasAfiliadas ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_empresasAfiliadas" )
			{
			...
			{
				result = " fetch_empresasAfiliadas            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_empresasAfiliadas             " + 
		...
		public void call_fetch_empresasAfiliadas ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_empresasAfiliadas Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_empresasAfiliadas ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_empresasAfiliadas ( ref st_nome_emp, ref lst ); 
