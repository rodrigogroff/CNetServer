...
{
	#if DEBUG 
	public class tst_exec_vincQuiosque : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_vincQuiosque transaction = new exec_vincQuiosque();
		...
		public tst_exec_vincQuiosque ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_vincQuiosque" )
			{
			...
			{
				result = " exec_vincQuiosque                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_vincQuiosque ( string st_quiosque, string st_empresa, string id_user, string tg_remover, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_vincQuiosque (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_vincQuiosque Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_vincQuiosque ( st_quiosque, st_empresa, id_user, tg_remover, ref  header ); 
