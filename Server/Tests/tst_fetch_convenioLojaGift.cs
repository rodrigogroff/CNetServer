...
{
	#if DEBUG 
	public class tst_fetch_convenioLojaGift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_convenioLojaGift transaction = new fetch_convenioLojaGift();
		...
		public tst_fetch_convenioLojaGift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_convenioLojaGift" )
			{
			...
			{
				result = " fetch_convenioLojaGift             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_convenioLojaGift ( string st_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_convenioLojaGift Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_convenioLojaGift ( st_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_convenioLojaGift ( ref st_banco, ref st_ag, ref st_conta ); 
