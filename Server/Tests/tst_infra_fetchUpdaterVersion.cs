...
{
	#if DEBUG 
	public class tst_infra_fetchUpdaterVersion : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public infra_fetchUpdaterVersion transaction = new infra_fetchUpdaterVersion();
		...
		public tst_infra_fetchUpdaterVersion ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "infra_fetchUpdaterVersion" )
			{
			...
			{
				result = " infra_fetchUpdaterVersion          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " infra_fetchUpdaterVersion           " + 
		...
		public void call_infra_fetchUpdaterVersion (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_infra_fetchUpdaterVersion ( ref string st_csv_files )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "infra_fetchUpdaterVersion Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_infra_fetchUpdaterVersion (  ); 
...
/// USER [ execute_1 ] END
			...
			recv_infra_fetchUpdaterVersion ( ref st_csv_files ); 
