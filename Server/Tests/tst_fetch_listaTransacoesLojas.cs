...
{
	#if DEBUG 
	public class tst_fetch_listaTransacoesLojas : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_listaTransacoesLojas transaction = new fetch_listaTransacoesLojas();
		...
		public tst_fetch_listaTransacoesLojas ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_listaTransacoesLojas" )
			{
			...
			{
				result = " fetch_listaTransacoesLojas         " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_listaTransacoesLojas          " + 
		...
		public void call_fetch_listaTransacoesLojas ( string dt_ini, string dt_fim, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_listaTransacoesLojas ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_listaTransacoesLojas Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_listaTransacoesLojas ( dt_ini, dt_fim, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_listaTransacoesLojas ( ref st_csv ); 
