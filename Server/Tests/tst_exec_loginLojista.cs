...
{
	#if DEBUG 
	public class tst_exec_loginLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_loginLojista transaction = new exec_loginLojista();
		...
		public tst_exec_loginLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_loginLojista" )
			{
			...
			{
				result = " exec_loginLojista                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_exec_loginLojista ( ref string nome )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_loginLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_loginLojista ( st_cnpj, st_senha ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_loginLojista ( ref nome ); 
