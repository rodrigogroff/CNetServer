...
{
	#if DEBUG 
	public class tst_exec_pos_cancelaVendaEmpresarial : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pos_cancelaVendaEmpresarial transaction = new exec_pos_cancelaVendaEmpresarial();
		...
		public tst_exec_pos_cancelaVendaEmpresarial ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pos_cancelaVendaEmpresarial" )
			{
			...
			{
				result = " exec_pos_cancelaVendaEmpresarial   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pos_cancelaVendaEmpresarial    " + 
		...
		public void call_exec_pos_cancelaVendaEmpresarial ( string st_nsu_cancel, string dt_hoje, string id_user, ref POS_Entrada pe ) 
		{
			m_Comm.Clear();
