...
{
	#if DEBUG 
	public class tst_ins_agenda : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_agenda transaction = new ins_agenda();
		...
		public bool Test()
		{
			...
			{
				result = " ins_agenda                         " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_agenda ( string st_empresa, string en_atividade, string en_tipo_schedule, string st_horario, string st_aux, string st_afiliada, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_agenda Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_agenda ( st_empresa, en_atividade, en_tipo_schedule, st_horario, st_aux, st_afiliada, ref  header ); 
