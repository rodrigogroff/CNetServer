...
{
	#if DEBUG 
	public class tst_fetch_limitesCartao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_limitesCartao transaction = new fetch_limitesCartao();
		...
		public tst_fetch_limitesCartao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_limitesCartao" )
			{
			...
			{
				result = " fetch_limitesCartao                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_limitesCartao ( string st_cpf, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_limitesCartao ( ref string st_csv_cartoes )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_limitesCartao Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_limitesCartao ( st_cpf, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_limitesCartao ( ref st_csv_cartoes ); 
