...
{
	#if DEBUG 
	public class tst_fetch_reciboVendaLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_reciboVendaLojista transaction = new fetch_reciboVendaLojista();
		...
		public tst_fetch_reciboVendaLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_reciboVendaLojista" )
			{
			...
			{
				result = " fetch_reciboVendaLojista           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_reciboVendaLojista            " + 
		...
		public void call_fetch_reciboVendaLojista ( string nsu_venda, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_reciboVendaLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_reciboVendaLojista ( nsu_venda, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_reciboVendaLojista ( ref lst ); 
