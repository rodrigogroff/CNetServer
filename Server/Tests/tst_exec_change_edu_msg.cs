...
{
	#if DEBUG 
	public class tst_exec_change_edu_msg : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_change_edu_msg transaction = new exec_change_edu_msg();
		...
		public tst_exec_change_edu_msg ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_change_edu_msg" )
			{
			...
			{
				result = " exec_change_edu_msg                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_change_edu_msg ( ref DadosEduMessage dem, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_change_edu_msg (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_change_edu_msg Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_change_edu_msg ( ref  dem, ref  header ); 
