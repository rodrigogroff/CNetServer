...
{
	#if DEBUG 
	public class tst_fetch_dadosAdministradora : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_dadosAdministradora transaction = new fetch_dadosAdministradora();
		...
		public tst_fetch_dadosAdministradora ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_dadosAdministradora" )
			{
			...
			{
				result = " fetch_dadosAdministradora          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_dadosAdministradora           " + 
		...
		public void call_fetch_dadosAdministradora ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_dadosAdministradora Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_dadosAdministradora ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_dadosAdministradora ( ref st_in_csv, ref st_out_csv ); 
