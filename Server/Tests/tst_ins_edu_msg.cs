...
{
	#if DEBUG 
	public class tst_ins_edu_msg : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_edu_msg transaction = new ins_edu_msg();
		...
		public tst_ins_edu_msg ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_edu_msg                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_edu_msg Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_edu_msg ( ref  dem, ref  header ); 
