...
{
	#if DEBUG 
	public class tst_fetch_dadosEmpresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_dadosEmpresa transaction = new fetch_dadosEmpresa();
		...
		public tst_fetch_dadosEmpresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_dadosEmpresa" )
			{
			...
			{
				result = " fetch_dadosEmpresa                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_dadosEmpresa ( string st_empresa, ref CNetHeader header ) 
		{
			m_Comm.Clear();
