...
{
	#if DEBUG 
	public class tst_fetch_reciboVendaGift : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_reciboVendaGift transaction = new fetch_reciboVendaGift();
		...
		public tst_fetch_reciboVendaGift ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_reciboVendaGift" )
			{
			...
			{
				result = " fetch_reciboVendaGift              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_reciboVendaGift ( string nsu, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_reciboVendaGift ( ref ArrayList lst )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_reciboVendaGift Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_reciboVendaGift ( nsu, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_reciboVendaGift ( ref lst ); 
