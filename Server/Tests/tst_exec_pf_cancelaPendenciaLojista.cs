...
{
	#if DEBUG 
	public class tst_exec_pf_cancelaPendenciaLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pf_cancelaPendenciaLojista transaction = new exec_pf_cancelaPendenciaLojista();
		...
		public tst_exec_pf_cancelaPendenciaLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pf_cancelaPendenciaLojista" )
			{
			...
			{
				result = " exec_pf_cancelaPendenciaLojista    " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pf_cancelaPendenciaLojista     " + 
		...
		public void call_exec_pf_cancelaPendenciaLojista ( string st_nsu_cancelado, string st_tel_lojista, string st_telefone ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pf_cancelaPendenciaLojista Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_nsu_cancelado = "";
			string st_tel_lojista = "";
			string st_telefone = "";
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pf_cancelaPendenciaLojista ( st_nsu_cancelado, st_tel_lojista, st_telefone ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pf_cancelaPendenciaLojista ( ref st_codResp, ref st_msg ); 
