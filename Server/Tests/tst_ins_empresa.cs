...
{
	#if DEBUG 
	public class tst_ins_empresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_empresa transaction = new ins_empresa();
		...
		public tst_ins_empresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_empresa                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_empresa ( ref DadosEmpresa de, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_empresa Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_empresa ( ref  de, ref  header ); 
