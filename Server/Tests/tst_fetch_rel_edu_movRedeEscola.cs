...
{
	#if DEBUG 
	public class tst_fetch_rel_edu_movRedeEscola : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_rel_edu_movRedeEscola transaction = new fetch_rel_edu_movRedeEscola();
		...
		public tst_fetch_rel_edu_movRedeEscola ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_rel_edu_movRedeEscola" )
			{
			...
			{
				result = " fetch_rel_edu_movRedeEscola        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_rel_edu_movRedeEscola         " + 
		...
		public void call_fetch_rel_edu_movRedeEscola ( string st_dt_ini, string st_dt_fim, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_rel_edu_movRedeEscola ( ref string st_content, ref string st_empresa )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_rel_edu_movRedeEscola Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_rel_edu_movRedeEscola ( st_dt_ini, st_dt_fim, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_rel_edu_movRedeEscola ( ref st_content, ref st_empresa ); 
