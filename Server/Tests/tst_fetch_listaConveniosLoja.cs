...
{
	#if DEBUG 
	public class tst_fetch_listaConveniosLoja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_listaConveniosLoja transaction = new fetch_listaConveniosLoja();
		...
		public tst_fetch_listaConveniosLoja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_listaConveniosLoja" )
			{
			...
			{
				result = " fetch_listaConveniosLoja           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_listaConveniosLoja            " + 
		...
		public void call_fetch_listaConveniosLoja ( string st_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_listaConveniosLoja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_listaConveniosLoja ( st_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_listaConveniosLoja ( ref st_cnpj, ref lst ); 
