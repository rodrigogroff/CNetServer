...
{
	#if DEBUG 
	public class tst_fetch_listaFiliais : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_listaFiliais transaction = new fetch_listaFiliais();
		...
		public tst_fetch_listaFiliais ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_listaFiliais" )
			{
			...
			{
				result = " fetch_listaFiliais                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_listaFiliais ( ref ArrayList lst )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_listaFiliais Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_listaFiliais ( ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_listaFiliais ( ref lst ); 
