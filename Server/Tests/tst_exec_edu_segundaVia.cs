...
{
	#if DEBUG 
	public class tst_exec_edu_segundaVia : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_edu_segundaVia transaction = new exec_edu_segundaVia();
		...
		public tst_exec_edu_segundaVia ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_edu_segundaVia" )
			{
			...
			{
				result = " exec_edu_segundaVia                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_edu_segundaVia ( string st_cartao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_edu_segundaVia (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_edu_segundaVia Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_edu_segundaVia ( st_cartao, ref  header ); 
