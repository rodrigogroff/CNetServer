...
{
	#if DEBUG 
	public class tst_ins_cartaoProprietario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_cartaoProprietario transaction = new ins_cartaoProprietario();
		...
		public tst_ins_cartaoProprietario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "ins_cartaoProprietario" )
			{
			...
			{
				result = " ins_cartaoProprietario             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_ins_cartaoProprietario (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_cartaoProprietario Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_cartaoProprietario ( st_csv_deps, ref  dc, ref  dp, ref  da, ref  header ); 
