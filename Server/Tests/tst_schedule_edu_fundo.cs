...
{
	#if DEBUG 
	public class tst_schedule_edu_fundo : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_edu_fundo transaction = new schedule_edu_fundo();
		...
		public tst_schedule_edu_fundo ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_edu_fundo" )
			{
			...
			{
				result = " schedule_edu_fundo                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_edu_fundo (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_edu_fundo (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_edu_fundo Item1", ref m_Log );
