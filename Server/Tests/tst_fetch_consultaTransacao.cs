...
{
	#if DEBUG 
	public class tst_fetch_consultaTransacao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_consultaTransacao transaction = new fetch_consultaTransacao();
		...
		public tst_fetch_consultaTransacao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_consultaTransacao" )
			{
			...
			{
				result = " fetch_consultaTransacao            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_consultaTransacao             " + 
		...
		public void recv_fetch_consultaTransacao ( ref string st_csv_id )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_consultaTransacao Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_consultaTransacao ( ref  dct, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_consultaTransacao ( ref st_csv_id ); 
