...
{
	#if DEBUG 
	public class tst_exec_depotEduImediato : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_depotEduImediato transaction = new exec_depotEduImediato();
		...
		public tst_exec_depotEduImediato ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_depotEduImediato" )
			{
			...
			{
				result = " exec_depotEduImediato              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_depotEduImediato ( string st_pass, string vr_valor, string st_valor_imediato, string st_empresa, string st_cartao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_depotEduImediato (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_depotEduImediato Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_pass = "";
			string vr_valor = "";
			string st_valor_imediato = "";
			string st_empresa = "";
			string st_cartao = "";
...
/// USER [ setup_test_1 ] END
			...
			call_exec_depotEduImediato ( st_pass, vr_valor, st_valor_imediato, st_empresa, st_cartao, ref  header ); 
