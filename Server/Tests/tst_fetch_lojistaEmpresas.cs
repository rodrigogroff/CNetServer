...
{
	#if DEBUG 
	public class tst_fetch_lojistaEmpresas : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_lojistaEmpresas transaction = new fetch_lojistaEmpresas();
		...
		public tst_fetch_lojistaEmpresas ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_lojistaEmpresas" )
			{
			...
			{
				result = " fetch_lojistaEmpresas              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_lojistaEmpresas ( string st_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_lojistaEmpresas Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_lojistaEmpresas ( st_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_lojistaEmpresas ( ref lst ); 
