...
{
	#if DEBUG 
	public class tst_fetch_cartoes_grafica : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_cartoes_grafica transaction = new fetch_cartoes_grafica();
		...
		public tst_fetch_cartoes_grafica ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_cartoes_grafica" )
			{
			...
			{
				result = " fetch_cartoes_grafica              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_cartoes_grafica ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_cartoes_grafica Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_cartoes_grafica ( st_empresa, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_cartoes_grafica ( ref st_csv ); 
