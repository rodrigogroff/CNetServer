...
{
	#if DEBUG 
	public class tst_fetch_canc_dia_lojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_canc_dia_lojista transaction = new fetch_canc_dia_lojista();
		...
		public tst_fetch_canc_dia_lojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_canc_dia_lojista" )
			{
			...
			{
				result = " fetch_canc_dia_lojista             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_canc_dia_lojista ( ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_canc_dia_lojista ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_canc_dia_lojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_canc_dia_lojista ( ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_canc_dia_lojista ( ref st_content ); 
