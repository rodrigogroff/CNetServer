...
{
	#if DEBUG 
	public class tst_exec_alteraTerminal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraTerminal transaction = new exec_alteraTerminal();
		...
		public tst_exec_alteraTerminal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraTerminal" )
			{
			...
			{
				result = " exec_alteraTerminal                " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_alteraTerminal ( string st_terminal, string st_localizacao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_alteraTerminal (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_alteraTerminal Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_terminal = "";
			string st_localizacao = "";
...
/// USER [ setup_test_1 ] END
			...
			call_exec_alteraTerminal ( st_terminal, st_localizacao, ref  header ); 
