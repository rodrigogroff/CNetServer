...
{
	#if DEBUG 
	public class tst_exec_cancel_Loja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_cancel_Loja transaction = new exec_cancel_Loja();
		...
		public tst_exec_cancel_Loja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_cancel_Loja" )
			{
			...
			{
				result = " exec_cancel_Loja                   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_cancel_Loja ( string st_cnpj, string st_motivo, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_cancel_Loja (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_cancel_Loja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_cancel_Loja ( st_cnpj, st_motivo, ref  header ); 
