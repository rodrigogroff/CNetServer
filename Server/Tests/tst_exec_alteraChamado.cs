...
{
	#if DEBUG 
	public class tst_exec_alteraChamado : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraChamado transaction = new exec_alteraChamado();
		...
		public tst_exec_alteraChamado ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraChamado" )
			{
			...
			{
				result = " exec_alteraChamado                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_alteraChamado ( string id_chamado, string st_new_desc, string tg_fechado, string st_operador, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_alteraChamado (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_alteraChamado Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_alteraChamado ( id_chamado, st_new_desc, tg_fechado, st_operador, ref  header ); 
