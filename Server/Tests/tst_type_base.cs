...
{
	#if DEBUG 
	public class tst_type_base : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public type_base transaction = new type_base();
		...
		public tst_type_base ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " type_base                          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "type_base Item1", ref m_Log );
