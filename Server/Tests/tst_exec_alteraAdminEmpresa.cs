...
{
	#if DEBUG 
	public class tst_exec_alteraAdminEmpresa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraAdminEmpresa transaction = new exec_alteraAdminEmpresa();
		...
		public tst_exec_alteraAdminEmpresa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraAdminEmpresa" )
			{
			...
			{
				result = " exec_alteraAdminEmpresa            " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_alteraAdminEmpresa             " + 
		...
		public void call_exec_alteraAdminEmpresa ( string st_empresa_admin, string tg_remover, string st_empresa_destino, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_alteraAdminEmpresa (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_alteraAdminEmpresa Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_empresa_admin = "";
			string tg_remover = "";
			string st_empresa_destino = "";
...
/// USER [ setup_test_1 ] END
			...
			call_exec_alteraAdminEmpresa ( st_empresa_admin, tg_remover, st_empresa_destino, ref  header ); 
