...
{
	#if DEBUG 
	public class tst_ins_dependente : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_dependente transaction = new ins_dependente();
		...
		public tst_ins_dependente ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "ins_dependente" )
			{
			...
			{
				result = " ins_dependente                     " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_dependente ( string st_empresa, string st_matricula, string st_dependente, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_ins_dependente (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_dependente Item1", ref m_Log );

			transaction.ut_abort = 0;

			string st_empresa = "";
			string st_matricula = "";
			string st_dependente = "";
...
/// USER [ setup_test_1 ] END
			...
			call_ins_dependente ( st_empresa, st_matricula, st_dependente, ref  header ); 
