...
{
	#if DEBUG 
	public class tst_exec_pos_vendaEmpresarial : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_pos_vendaEmpresarial transaction = new exec_pos_vendaEmpresarial();
		...
		public tst_exec_pos_vendaEmpresarial ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_pos_vendaEmpresarial" )
			{
			...
			{
				result = " exec_pos_vendaEmpresarial          " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_pos_vendaEmpresarial           " + 
		...
		public void recv_exec_pos_vendaEmpresarial ( ref string st_msg, ref POS_Resposta pr )
		{
			...
			m_Comm.GetExitPortableAtPosition (1).GetMapContainer ( COMM_OUT_EXEC_POS_VENDAEMPRESARIAL.pr , ref recv_dp_cont_pr );
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_pos_vendaEmpresarial Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_pos_vendaEmpresarial ( ref  pe ); 
...
/// USER [ execute_1 ] END
			...
			recv_exec_pos_vendaEmpresarial ( ref st_msg, ref pr ); 
