...
{
	#if DEBUG 
	public class tst_del_Terminal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public del_Terminal transaction = new del_Terminal();
		...
		public tst_del_Terminal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " del_Terminal                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_del_Terminal ( string st_loja_cnpj, string st_terminal, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "del_Terminal Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_del_Terminal ( st_loja_cnpj, st_terminal, ref  header ); 
