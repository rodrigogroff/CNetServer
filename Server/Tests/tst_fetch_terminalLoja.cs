...
{
	#if DEBUG 
	public class tst_fetch_terminalLoja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_terminalLoja transaction = new fetch_terminalLoja();
		...
		public tst_fetch_terminalLoja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_terminalLoja" )
			{
			...
			{
				result = " fetch_terminalLoja                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_terminalLoja ( string st_cnpj_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_terminalLoja ( ref ArrayList lst )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_terminalLoja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_terminalLoja ( st_cnpj_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_terminalLoja ( ref lst ); 
