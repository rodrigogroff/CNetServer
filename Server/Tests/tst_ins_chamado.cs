...
{
	#if DEBUG 
	public class tst_ins_chamado : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_chamado transaction = new ins_chamado();
		...
		public tst_ins_chamado ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_chamado                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_chamado Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_chamado ( ref  dc, ref  header ); 
