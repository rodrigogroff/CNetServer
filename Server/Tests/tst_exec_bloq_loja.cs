...
{
	#if DEBUG 
	public class tst_exec_bloq_loja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_bloq_loja transaction = new exec_bloq_loja();
		...
		public tst_exec_bloq_loja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_bloq_loja" )
			{
			...
			{
				result = " exec_bloq_loja                     " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_bloq_loja ( string st_cnpj, string st_motivo, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_bloq_loja (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_bloq_loja Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_bloq_loja ( st_cnpj, st_motivo, ref  header ); 
