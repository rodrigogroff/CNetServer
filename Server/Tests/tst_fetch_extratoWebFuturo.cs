...
{
	#if DEBUG 
	public class tst_fetch_extratoWebFuturo : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_extratoWebFuturo transaction = new fetch_extratoWebFuturo();
		...
		public tst_fetch_extratoWebFuturo ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_extratoWebFuturo" )
			{
			...
			{
				result = " fetch_extratoWebFuturo             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_fetch_extratoWebFuturo ( ref string st_content )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_extratoWebFuturo Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_extratoWebFuturo ( st_cartao, st_senha ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_extratoWebFuturo ( ref st_content ); 
