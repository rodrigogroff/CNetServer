...
{
	#if DEBUG 
	public class tst_exec_edu_habilita : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_edu_habilita transaction = new exec_edu_habilita();
		...
		public tst_exec_edu_habilita ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_edu_habilita" )
			{
			...
			{
				result = " exec_edu_habilita                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_edu_habilita ( string st_cartao, string st_senha, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_edu_habilita (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_edu_habilita Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_edu_habilita ( st_cartao, st_senha, ref  header ); 
