...
{
	#if DEBUG 
	public class tst_schedule_educacional : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public schedule_educacional transaction = new schedule_educacional();
		...
		public tst_schedule_educacional ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "schedule_educacional" )
			{
			...
			{
				result = " schedule_educacional               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_schedule_educacional (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_schedule_educacional (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "schedule_educacional Item1", ref m_Log );
