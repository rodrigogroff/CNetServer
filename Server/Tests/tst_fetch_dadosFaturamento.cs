...
{
	#if DEBUG 
	public class tst_fetch_dadosFaturamento : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_dadosFaturamento transaction = new fetch_dadosFaturamento();
		...
		public tst_fetch_dadosFaturamento ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_dadosFaturamento" )
			{
			...
			{
				result = " fetch_dadosFaturamento             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_dadosFaturamento ( string tg_empresa, string st_codigo, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_dadosFaturamento Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_dadosFaturamento ( tg_empresa, st_codigo, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_dadosFaturamento ( ref st_msg, ref vr_valor ); 
