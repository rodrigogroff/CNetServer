...
{
	#if DEBUG 
	public class tst_exec_edu_cancelaCartao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_edu_cancelaCartao transaction = new exec_edu_cancelaCartao();
		...
		public tst_exec_edu_cancelaCartao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_edu_cancelaCartao" )
			{
			...
			{
				result = " exec_edu_cancelaCartao             " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_exec_edu_cancelaCartao (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_edu_cancelaCartao Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_edu_cancelaCartao ( st_cartao, ref  header ); 
