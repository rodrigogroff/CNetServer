...
{
	#if DEBUG 
	public class tst_exec_processaArqBancario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_processaArqBancario transaction = new exec_processaArqBancario();
		...
		public tst_exec_processaArqBancario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_processaArqBancario" )
			{
			...
			{
				result = " exec_processaArqBancario           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " exec_processaArqBancario            " + 
		...
		public void recv_exec_processaArqBancario (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_processaArqBancario Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_processaArqBancario ( st_id, ref  header ); 
