...
{
	#if DEBUG 
	public class tst_exec_alteraCartao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_alteraCartao transaction = new exec_alteraCartao();
		...
		public tst_exec_alteraCartao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_alteraCartao" )
			{
			...
			{
				result = " exec_alteraCartao                  " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void recv_exec_alteraCartao (  )
		{
		}
