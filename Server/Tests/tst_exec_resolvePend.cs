...
{
	#if DEBUG 
	public class tst_exec_resolvePend : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_resolvePend transaction = new exec_resolvePend();
		...
		public tst_exec_resolvePend ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_resolvePend" )
			{
			...
			{
				result = " exec_resolvePend                   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_resolvePend ( string nsu, string dt_ini, string tg_confirmada, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_resolvePend (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_resolvePend Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_resolvePend ( nsu, dt_ini, tg_confirmada, ref  header ); 
