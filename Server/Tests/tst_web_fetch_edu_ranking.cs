...
{
	#if DEBUG 
	public class tst_web_fetch_edu_ranking : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public web_fetch_edu_ranking transaction = new web_fetch_edu_ranking();
		...
		public tst_web_fetch_edu_ranking ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "web_fetch_edu_ranking" )
			{
			...
			{
				result = " web_fetch_edu_ranking              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_web_fetch_edu_ranking (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_web_fetch_edu_ranking ( ref string st_csv )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "web_fetch_edu_ranking Item1", ref m_Log );
...
/// USER [ execute_1 ] END
			...
			recv_web_fetch_edu_ranking ( ref st_csv ); 
