...
{
	#if DEBUG 
	public class tst_ins_terminal : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_terminal transaction = new ins_terminal();
		...
		public tst_ins_terminal ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_terminal                       " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
