...
{
	#if DEBUG 
	public class tst_fetch_codLoja : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_codLoja transaction = new fetch_codLoja();
		...
		public tst_fetch_codLoja ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_codLoja" )
			{
			...
			{
				result = " fetch_codLoja                      " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_codLoja ( ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_codLoja ( ref string st_cod )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_codLoja Item1", ref m_Log );
