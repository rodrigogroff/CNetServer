...
{
	#if DEBUG 
	public class tst_exec_conf_cartao : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_conf_cartao transaction = new exec_conf_cartao();
		...
		public tst_exec_conf_cartao ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_conf_cartao" )
			{
			...
			{
				result = " exec_conf_cartao                   " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_conf_cartao ( string st_cartao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_conf_cartao (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_conf_cartao Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_conf_cartao ( st_cartao, ref  header ); 
