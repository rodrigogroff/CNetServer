...
{
	#if DEBUG 
	public class tst_exec_fat_recManual : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_fat_recManual transaction = new exec_fat_recManual();
		...
		public tst_exec_fat_recManual ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_fat_recManual" )
			{
			...
			{
				result = " exec_fat_recManual                 " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_fat_recManual ( string tg_empresa, string st_codigo, string vr_valor, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_fat_recManual (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_fat_recManual Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_fat_recManual ( tg_empresa, st_codigo, vr_valor, ref  header ); 
