...
{
	#if DEBUG 
	public class tst_fetch_pf_telefoneLojista : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_pf_telefoneLojista transaction = new fetch_pf_telefoneLojista();
		...
		public tst_fetch_pf_telefoneLojista ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_pf_telefoneLojista" )
			{
			...
			{
				result = " fetch_pf_telefoneLojista           " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
			...
			result = " fetch_pf_telefoneLojista            " + 
		...
		public void call_fetch_pf_telefoneLojista ( string st_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_fetch_pf_telefoneLojista ( ref string st_telefone )
		{
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_pf_telefoneLojista Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_pf_telefoneLojista ( st_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_pf_telefoneLojista ( ref st_telefone ); 
