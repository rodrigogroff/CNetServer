...
{
	#if DEBUG 
	public class tst_load_edu_emp_virtual : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public load_edu_emp_virtual transaction = new load_edu_emp_virtual();
		...
		public tst_load_edu_emp_virtual ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "load_edu_emp_virtual" )
			{
			...
			{
				result = " load_edu_emp_virtual               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_load_edu_emp_virtual (  ) 
		{
			m_Comm.Clear();
		}

		public void recv_load_edu_emp_virtual (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "load_edu_emp_virtual Item1", ref m_Log );
