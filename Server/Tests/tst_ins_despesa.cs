...
{
	#if DEBUG 
	public class tst_ins_despesa : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public ins_despesa transaction = new ins_despesa();
		...
		public tst_ins_despesa ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " ins_despesa                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_ins_despesa ( string vr_cobranca, string st_codigo, string tg_empresa, string st_extra, string tg_desconto, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "ins_despesa Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_ins_despesa ( vr_cobranca, st_codigo, tg_empresa, st_extra, tg_desconto, ref  header ); 
