...
{
	#if DEBUG 
	public class tst_fetch_rel_repEfetivo : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public fetch_rel_repEfetivo transaction = new fetch_rel_repEfetivo();
		...
		public tst_fetch_rel_repEfetivo ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "fetch_rel_repEfetivo" )
			{
			...
			{
				result = " fetch_rel_repEfetivo               " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_fetch_rel_repEfetivo ( string st_empresa, string dt_ini, string dt_fim, string st_loja, ref CNetHeader header ) 
		{
			m_Comm.Clear();
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "fetch_rel_repEfetivo Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_fetch_rel_repEfetivo ( st_empresa, dt_ini, dt_fim, st_loja, ref  header ); 
...
/// USER [ execute_1 ] END
			...
			recv_fetch_rel_repEfetivo ( ref st_csv_contents, ref st_csv_pagto, ref st_nome_empresa, ref st_csv_lojas ); 
