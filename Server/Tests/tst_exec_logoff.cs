...
{
	#if DEBUG 
	public class tst_exec_logoff : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_logoff transaction = new exec_logoff();
		...
		public tst_exec_logoff ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			...
			{
				result = " exec_logoff                        " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_logoff Item1", ref m_Log );
