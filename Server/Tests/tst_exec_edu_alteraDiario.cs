...
{
	#if DEBUG 
	public class tst_exec_edu_alteraDiario : tst_base
	{
/// USER [ usr_var_decl ]
/// USER [ usr_var_decl ] END

		public exec_edu_alteraDiario transaction = new exec_edu_alteraDiario();
		...
		public tst_exec_edu_alteraDiario ( ref StreamWriter p_m_Log, 
		...
		public bool Test()
		{
			if ( demand == "!" || demand == "exec_edu_alteraDiario" )
			{
			...
			{
				result = " exec_edu_alteraDiario              " + " ## no available coverage! ";
				currentItem++;
				return false;
			}
		...
		public void call_exec_edu_alteraDiario ( string st_pass, string vr_diario, string st_cartao, ref CNetHeader header ) 
		{
			m_Comm.Clear();
		...
		public void recv_exec_edu_alteraDiario (  )
		{
		}
...
/// USER [ custom_functions ] END
		...
		public bool Item1()
		{
			...
			tst_unit.LogTest ( "exec_edu_alteraDiario Item1", ref m_Log );
...
/// USER [ setup_test_1 ] END
			...
			call_exec_edu_alteraDiario ( st_pass, vr_diario, st_cartao, ref  header ); 
