...
{
	public class Exchange : ServerCOM
	{
		public Exchange ( string destination, int port, int max_packet_size )
		{
			m_Client = new DataClient ( destination, port, max_packet_size );
		}
		...
		public bool fetch_dadosEmpresa ( string st_empresa, string st_cnpj, ref CNetHeader header, ref DadosEmpresa de ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				send_dp.MapTagValue ( COMM_IN_FETCH_DADOSEMPRESA.st_cnpj, st_cnpj );
		...
		public bool exec_pos_cancelaVendaEmpresarial ( string st_nsu_cancel, string dt_hoje, ref POS_Entrada pe, ref string st_msg, ref POS_Resposta pr ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool fetch_rel_1_rtc ( string st_cart, string st_pf, string st_cidade, string st_estado, string st_loja, string st_dt_ini, string st_dt_fim, ref CNetHeader header, ref string st_csv, ref string st_empresa, ref string st_total_periodo, ref string st_cartao, ref string st_total_cancelado ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool exec_depotEduImediato ( string st_pass, string vr_valor, string st_cartao, string st_valor_imediato, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool fetch_rel_edu_extrato ( string st_cart, string st_dt_ini, string st_dt_fim, ref CNetHeader header, ref string st_csv, ref string st_empresa, ref string st_total_periodo ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				send_dp.MapTagValue ( COMM_IN_FETCH_REL_EDU_EXTRATO.st_cart, st_cart );
		...
		public bool exec_cancelaEmpresa ( string st_pass_user, string st_cnpj_loja, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				send_dp.MapTagValue ( COMM_IN_EXEC_CANCELAEMPRESA.st_cnpj_loja, st_cnpj_loja );
		...
		public bool web_fetch_resp_alunos ( string st_cpf, string st_senha, ref ArrayList lst ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool web_exec_trocaLim ( string st_cartao, string st_senha, string vr_dispDiario ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool fetch_comprov_Gift ( string id_gift, ref CNetHeader header, ref ArrayList lst ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool fetch_consultaCartaoGift ( string st_empresa, string st_matricula, ref CNetHeader header, ref string st_nome, ref string vr_disp, ref string st_sit, ref ArrayList lstCred, ref ArrayList lstProd ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool fetch_rel_repEfetivo ( string st_empresa, string dt_ini, string dt_fim, ref CNetHeader header, ref string st_csv_contents, ref string st_csv_pagto, ref string st_nome_empresa, ref string st_csv_lojas ) 
		{
			try
			{
				m_Client.ClearCommunication();
