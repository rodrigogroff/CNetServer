...
namespace Client
{
	public class Exchange : ClientExchange
	{
		...
		public bool fetch_usuarios ( string st_csv_list, ref CNetHeader header, ref string st_csv ) 
		{
			try
			{
				m_Client.ClearCommunication();
		...
		public bool exec_bloq_empresa ( string emp, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.exec_bloq_empresa );
		...
		public bool exec_desbloq_empresa ( string emp, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.exec_desbloq_empresa );
		...
		public bool fetch_cotaExtra_carts ( string emp, ref CNetHeader header, ref string csv ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.fetch_cotaExtra_carts );
		...
		public bool exec_cotaExtraEmpresa ( string emp, string valor, string csv_excluded, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.exec_cotaExtraEmpresa );
		...
		public bool fetch_rel_listaCarts ( string emp, ref CNetHeader header, ref string id, ref string nome_emp ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.fetch_rel_listaCarts );
		...
		public bool fetch_rel_listaLojas ( string emp, ref CNetHeader header, ref string id, ref string nome_emp ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.fetch_rel_listaLojas );
		...
		public bool exec_excluiCart ( string emp, string mat, string tit, ref CNetHeader header ) 
		{
			try
			{
				m_Client.ClearCommunication();
				...
				ArrayList objections = m_Client.ExecuteServerTransaction ( ServerTransactions.exec_excluiCart );
