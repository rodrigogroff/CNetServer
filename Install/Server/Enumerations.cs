...
namespace ServerSetup
{
	...
	public class InfraSoftwareServer
	{
		public const string nameServer = "ConveyNet";
		public const string db_schema = "AutorizadorCN";
		public const string pathDir = "pathDir";
		public const string db_choice = "db_choice";
		public const string slaveOnly = "slaveOnly";
		public const string db_machine = "db_machine";
		...
		public const string standByPort = "standByPort";
		public const string failFS = "failFS";
		public const string webStandBy = "webStandBy";
		
		public ArrayList GetArray()
		{
			return new ArrayList ( new string [] {  nameServer,
													db_schema,
													pathDir,
													db_choice,
													slaveOnly,
