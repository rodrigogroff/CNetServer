...
namespace Client
{
	public class event_dlgCancelaVendaPayFone : EventLayer
	{
		#region - EVENTS -
		...
		public const int event_val_TelLojista = 8;
		public const int event_BtnConfirmarClick = 9;
		#endregion

		public dlgCancelaVendaPayFone i_Form;
		...
		public override bool doEvent ( int event_number, object arg )
		{
			switch ( event_number )
			{
				...
				case event_Confirmar:
				{
					...
					if ( !ctrl_TxtTelLojista.IsUserValidated )	{	ctrl_TxtTelLojista.SetErrorMessage 	( "Telefone do lojista deve ter 10 caracteres" );	IsDone = false;	}
