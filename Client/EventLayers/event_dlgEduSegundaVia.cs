...
namespace Client
{
	public class event_dlgEduSegundaVia : EventLayer
	{
		#region - EVENTS -
		...
		public const int event_Emitir = 7;
		public const int event_val_TxtAluno = 8;
		public const int event_BtnEmitirClick = 9;
		#endregion

		public dlgEduSegundaVia i_Form;
		...
		public event_dlgEduSegundaVia ( ApplicationUtil util, Exchange ex )
		{
			var_util = util;
			var_exchange = ex;
		
			i_Form = new dlgEduSegundaVia ( this );
		}
		...
		public override bool doEvent ( int event_number, object arg )
		{
			switch ( event_number )
			{
				...
				case event_Emitir:
				{
					//InitEventCode event_Emitir
				
					if ( i_Form.LstAlunos.SelectedIndex == -1 )
						return false;
					
					if ( MessageBox.Show (	"Emitir nova via de cartão?",
			                    			"Aviso", 
					...
					var_exchange.exec_edu_segundaVia ( cart, ref header );					                                   
				...
				#region - event_BtnEmitirClick -
				
				case event_BtnEmitirClick:
				{
					//InitEventCode event_BtnEmitirClick
					//EndEventCode
					return true;
				}
