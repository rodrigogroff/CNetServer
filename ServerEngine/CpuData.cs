...
namespace SyCrafEngine
{
  ...
  {
    public double milisec_idle_work;
    public double milisec_cpu_work;
    public double milisec_cpu_slowest;
    public double milisec_avg_idle;
    public double milisec_avg_sql;
    public double totSqlCalls;
  }
}
